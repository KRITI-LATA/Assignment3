...
class App extends Component {
  ...
  render() {
    const {isMatch, category, score, time, imgUrl} = this.state
          ...
          <ul className="score-container">
            <li className="score-name">
              <p className="score-text">
                score: <span className="num-score">{score}</span>
              </p>
            </li>
            ...
            <div className="first-div">
              ...
              <ul className="name-list">
                {tabsList.map(eachList => (
                  <li className="list" key={eachList.tabId}>
                    <button
                      type="button"
                      className={`container-btn ${
                        category === eachList.tabId ? 'btn-border' : ''
                      }`}
              ...
              <ul className="thumbnail-container">
                {thumbnailList.map(eachObject => (
                  <li className="image-list" key={eachObject.id}>
                    <button
                      className="thumb-nail-btn"
                      type="button"
